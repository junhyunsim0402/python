...
# [1] 여러가지 특성에 분류 모델 
import pandas as pd 
df = pd.read_csv( './pythonML/day5/Fish.csv')
# 어종 7개 , Species
...
train_input , test_input , train_target , teset_target = train_test_split( fish_input , fish_target , random_state=42)
# 스케일링 
...
z = np.arange( -100 , 100 , 0.1 ) # -5 부터 5 까지 0.1씩 증가 하는 리스트 
...
print(lr.score(test_scaled,teset_target)) # 0.85
