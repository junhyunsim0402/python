...
import pandas as pd 
df = pd.read_csv( './pythonML/day3/Iris.csv')
...
print(lr.predict([[4**2,4]])) # [2.83968176]
print(lr.predict([[6**2,6]])) # [4.31020745]
...
# 1차는 y=ax+b형태로 직선만 가능하고 2차는 곡선으로 데이터의 표현을 더 잘해준다?